...
export interface ContainerAccessibilityProps extends BaseAccessibilityProps {
  ...
  'aria-relevant'?: 'additions' | 'removals' | 'text' | 'all' | 'additions removals' | 'additions text' | 'removals text' | 'text additions' | 'text removals' | 'removals additions';
  
  /** Landmark role for page structure */
  role?: 'banner' | 'navigation' | 'main' | 'complementary' | 'contentinfo' | 'search' | 'form' | 'region' | string;
}

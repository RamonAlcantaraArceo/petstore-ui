/**
 * Chef (chef) pseudo-locale translations
 * Swedish Chef character expansion for testing text length and international characters
 * Approximately 30% character expansion to test layout flexibility
 */
...
export const chef = {
  ...
  stories: {
    button: {
      ...
      description: 'Bäsïç büttön çømpønëñt wïth mültïplë värïäñts, sïzës, äñd äççëssïßïlïty fëätürës. Süppørts prïmäry, sëçøñdäry, äñd däñgër çølør sçhëmës - børk børk äll zee øptïøñs!',
      variants: {
      ...
      accessibility: {
        ...
        description: 'Dëmøñsträtës büttön äççëssïßïlïty fëätürës ïñçlüdïñg ÄRÏÄ läßëls, føçüs mäñägëmëñt, äñd kë yßøärd nävïgätïøñ - børk børk äll üsërs wëlçømë!'
      },
      allVariants: {
        title: 'Äll Värïäñts Shøwñ - børk børk çømpärë äll!',
        description: 'Shøws äll büttön värïäñts ïñ ä sïñglë vïëw før çømpärïsøñ - børk børk sëë äll øptïøñs tøgëthër!'
      }
    },
    input: {
      title: 'Ïñpüt Çømpønëñt - børk børk zee typïñg fïëld!',
      description: 'Förm ïñpüt çømpønëñt wïth väl ïdätïøñ, äççëssïßïlïty fëätürës, äñd mültïplë typës - børk børk äll data ïñpüts!',
      variants: {
    ...
    card: {
      ...
      description: 'Flëxïßlë çärd çømpønëñt för dïsplayïñg cøñtént wïth øptïøñal hëädërs, føøtërs, äñd äçtïøñs - børk børk äll zee ïñfø!',
      variants: {
      ...
      examples: {
        ...
        content: 'Thïs ïs äñ éxämplë çärd wïth sømë cøñtént tø dëmøñsträtë thee çømpønëñt füñçtïøñälïty - børk børk äll zee ïñförmatïøñ shøwñ hërë!',
  ...
  accessibility: {
    ...
    instructions: {
      ...
      buttonActivation: 'Prëss Éñtër ør Spä çë kéy tø äçtïvä të zee büttön - børk børk mäkë ït wørk!',
...
export type ChefLocale = typeof chef;
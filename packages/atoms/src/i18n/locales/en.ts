  ...
  petstore: {
    ...
    app: {
      ...
      shell: {
        ...
        errorInspectorTitle: 'Request Error Inspector',
        ...
        errorInspectorResponseTab: 'Response',
        errorInspectorCopyCurl: 'Copy cURL request',
        errorInspectorCopyDetails: 'Copy error details',
        errorInspectorCopiedCurl: 'cURL request copied',

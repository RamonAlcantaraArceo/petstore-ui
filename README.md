...
## Selector conventions for atoms and molecules

- Every atom and molecule root should expose `data-component="<ComponentName>"` using the component's PascalCase name.
